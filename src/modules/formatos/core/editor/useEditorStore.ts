/**
 * Store del editor de formatos (Zustand).
 *
 * Vive dentro del módulo `formatos/core/editor` porque es estado de UI del
 * editor genérico. Los tipos `Bloque`/`TipoBloque` provienen del plugin
 * SAFA (host) — el core los acepta vía `BlockInstance`.
 */
