/**
 * Catálogo de tokens "amigables" del dominio SAFA (`{{grupo.campo}}`).
 *
 * Mapean a `AutoFieldKey`s del catálogo de campos auto, y se usan en el
 * editor de plantillas para insertar tokens y para resolverlos en runtime.
 */
